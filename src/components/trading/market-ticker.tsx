...
export function MarketTicker() {
    ...
    // Prepare content
    const items = loading ? [] : MARKET_DATA
        ...
        <>
            {items.map((item, i) => (
                <button
                    ...
                    className="flex-shrink-0 flex items-center gap-2 pl-3 pr-2 py-1 bg-muted/40 border rounded-full hover:bg-muted active:scale-95 hover:border-primary/50 transition-all w-auto h-8 select-none"
                    type="button"
                >
    ...
    return (
        <div className="w-full bg-background border-b overflow-hidden relative h-12 flex items-center">
